(function () {
  ...
  const translations = {
    ar: {
      ...
      "products.pipes.lead":
        "أنابيب جاهزة مسلحة لصرف الأمطار والصرف الصحي والعبارات.",
      ...
      "products.pipes.li3": "وصلات سن وقفة أو لسان وأخدود",
      "products.pipes.li4": "أطوال قياسية",
      ...
      "products.interlock.lead":
        "وحدات إنترلوك للمداخل وأرصفة المشاة ومواقف السيارات والحدائق.",
      "products.interlock.li1": "أشكال ومقاسات إنترلوك قياسية",
      "products.interlock.li2": "خيارات اللون والتشطيب",
      "products.interlock.li3": "أرصفة وملحقات",
    ...
    en: {
      ...
      "products.pipes.lead":
        "Steel-reinforced precast pipes for stormwater, sewage, and culvert applications.",
      ...
      "products.pipes.li3": "Spigot & socket, tongue & groove joints",
      "products.pipes.li4": "Standard lengths",
      ...
      "contact.hours.weekend": "Friday: Closed",
